...
def get_solution_of_portfolio_company(text):
    ...
    Answer the task based on the context below. Keep the answer only in the format I have written below and not in any other format. Just write "-" and nothing else if you not sure about the answer or if there is no info about it at all. Don't ask questions. Don't write anything else. Don't write your explanations.
Task: Analyze the context given to you at the very end and find out what user problems this startup is solving. Describe it briefly, clearly and simply. 5 sentences.
